...
export const IntegrationsModule: React.FC<IntegrationsModuleProps> = ({
  ...
  const integrationGuides: Record<string, IntegrationGuideDetail> = {
    ...
    int_whatsapp: {
      ...
      steps: [
        '1. Go to developers.facebook.com and open your Meta App (App ID 946589648227889).',
        '2. Ensure your Meta App has whatsapp_business_management and whatsapp_business_messaging permissions.',
        '3. In the left navigation, click "WhatsApp" > "Configuration".',
        '4. Click "Edit" next to the Webhook section.',
        `5. Callback URL: ${origin}/api/webhooks/whatsapp`,
        `6. Verify Token: ansury_wa_verify_2026 (or your custom token from Coexistence Settings).`,
        '7. Click "Verify and Save" (Ansury responds instantly with HTTP 200 and challenge verification).',
        '8. Click "Manage Webhook fields" and subscribe to "messages" and "message_template_status_update".',
        '9. Inbound WhatsApp messages and Coexistence status will now stream in real time into the Inbox!',
      ],
      tips: [
        'Entity ID Check: Business Portfolio ID (e.g. 648719564147989 - SOLAR GEAR Limited) is for portfolio ownership/billing; WhatsApp Business Account (WABA) ID (e.g. 1495781001950663 - Solar Gear) is used for API calls & messaging.',
        'Avoid Error #1690130 ("Invalid Business ID"): Never pass the Business Portfolio ID into the WABA ID field in SDK configurations.',
        'WAMID deduplication is built-in to prevent dual delivery across the WhatsApp Business Mobile App and Cloud API.',
      ],
    },
    int_shopify: {
      id: 'int_shopify',
